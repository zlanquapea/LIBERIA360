...
export default async function NewWeekendPage() {
  ...
  return (
    <main className="mx-auto flex max-w-sm flex-col gap-6 px-4 py-10">
      <div>
        <h1 className="text-xl font-bold text-slate-900 dark:text-slate-50">Weekend Explorer</h1>
        <p className="text-sm text-slate-500 dark:text-slate-400">Find what&apos;s within reach for a quick getaway.</p>
      </div>
