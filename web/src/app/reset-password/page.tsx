...
function ResetPasswordForm() {
  ...
  if (!token) {
    return (
      <main className="mx-auto flex max-w-sm flex-col gap-4 px-4 py-10 text-center">
        <h1 className="text-xl font-bold text-slate-900 dark:text-slate-50">Invalid reset link</h1>
  ...
  if (done) {
    return (
      <main className="mx-auto flex max-w-sm flex-col gap-4 px-4 py-10 text-center">
        <h1 className="text-xl font-bold text-slate-900 dark:text-slate-50">Password updated</h1>
        <p className="text-sm text-slate-500 dark:text-slate-400">Taking you to the log-in page…</p>
      </main>
    );
  }
  ...
  return (
    <main className="mx-auto flex max-w-sm flex-col gap-6 px-4 py-10">
      <div>
        <h1 className="text-xl font-bold text-slate-900 dark:text-slate-50">Choose a new password</h1>
      </div>
