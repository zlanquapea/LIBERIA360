...
/**
 * A compact, touch-friendly shortcut row under the homepage search field.
 * Each chip maps to an existing route/query parameter; there are no dead
 * buttons or claims about data that the API does not currently expose.
 */
