...
export function CreatorFeed({
  ...
  return (
    ...
    >
      ...
      {loadingInitial ? (
        <div className="flex flex-col items-center gap-3 rounded-3xl border border-slate-200 bg-white px-5 py-10 text-center dark:border-slate-800 dark:bg-slate-900">
          <BrandLoader />
