...
export function BottomNav() {
  ...
  return (
    <nav
      ...
      className="fixed inset-x-0 bottom-0 z-30 border-t border-white/10 bg-brand-900/95 pt-1 text-white shadow-[0_-8px_24px_rgba(0,47,59,0.16)] backdrop-blur supports-[backdrop-filter]:bg-brand-900/85 lg:hidden"
    >
