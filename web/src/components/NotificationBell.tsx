  ...
  return (
    <div ref={containerRef} className="relative">
      <button
        ...
        aria-expanded={open}
        className="relative flex h-9 w-9 items-center justify-center rounded-full border border-white/30 bg-white/5 text-white/90 transition-colors hover:border-white hover:bg-white hover:text-lagoon-900 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gold-400"
      >
