      ...
      {groups.map((group) => {
        ...
        return (
          <div key={group.id} className="flex flex-col">
            ...
            {isExpanded && (
              <div className="ml-3 flex flex-col gap-0.5 border-l border-slate-200 py-1 pl-3 dark:border-slate-800">
                {group.items.map((item) => {
                  ...
                  return (
                    <Link
                      ...
                      onClick={onNavigate}
                      aria-current={active ? "page" : undefined}
                      className={`flex min-h-10 items-center rounded-xl px-3 py-2 text-sm transition-colors ${
                        active
