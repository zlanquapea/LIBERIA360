...
export const confirmSupportResolved = (token: string, id: string) =>
...
export const assignSupportTicketToMe = (token: string, id: string) =>
  apiRequest<SupportTicket>(`/admin/support/tickets/${id}/assign-to-me`, {
    method: "POST",
    headers: authHeader(token),
  });
