...
export class InitSchema1786792759612 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_b98eccb7d9b9e051de2b3b8f94" ON "activities" ("place_id") `);
        await queryRunner.query(`CREATE TYPE "public"."places_type_enum" AS ENUM('attraction', 'nature_site', 'hotel', 'restaurant', 'activity_provider')`);
        await queryRunner.query(`CREATE TYPE "public"."places_recommended_visit_length_enum" AS ENUM('day_trip', 'overnight', 'multi_day')`);
        await queryRunner.query(`CREATE TYPE "public"."places_verification_status_enum" AS ENUM('unverified', 'verified', 'recommended', 'official', 'eco_certified', 'community_favorite')`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_098697c7be32519a2621a16af1" ON "places" ("category_id") `);
        await queryRunner.query(`CREATE INDEX "IDX_b57fda6a971fc9e58b2b2b2a80" ON "places" ("county_id") `);
        await queryRunner.query(`ALTER TABLE "activities" ADD CONSTRAINT "FK_b98eccb7d9b9e051de2b3b8f94f" FOREIGN KEY ("place_id") REFERENCES "places"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "places" ADD CONSTRAINT "FK_098697c7be32519a2621a16af17" FOREIGN KEY ("category_id") REFERENCES "categories"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "places" ADD CONSTRAINT "FK_b57fda6a971fc9e58b2b2b2a80d" FOREIGN KEY ("county_id") REFERENCES "counties"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "places" DROP CONSTRAINT "FK_b57fda6a971fc9e58b2b2b2a80d"`);
        await queryRunner.query(`ALTER TABLE "places" DROP CONSTRAINT "FK_098697c7be32519a2621a16af17"`);
        await queryRunner.query(`ALTER TABLE "activities" DROP CONSTRAINT "FK_b98eccb7d9b9e051de2b3b8f94f"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_b57fda6a971fc9e58b2b2b2a80"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_098697c7be32519a2621a16af1"`);
        await queryRunner.query(`DROP TABLE "places"`);
        await queryRunner.query(`DROP TYPE "public"."places_verification_status_enum"`);
        await queryRunner.query(`DROP TYPE "public"."places_recommended_visit_length_enum"`);
        await queryRunner.query(`DROP TYPE "public"."places_type_enum"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_b98eccb7d9b9e051de2b3b8f94"`);
