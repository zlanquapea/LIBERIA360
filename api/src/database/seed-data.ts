import { PlaceType, RecommendedVisitLength, VerificationStatus } from '../places/entities/place.enums';
...
export const CATEGORY_SEEDS: CategorySeed[] = [
  { name: 'Beaches', slug: 'beaches', icon: '🏖️', description: 'Coastal spots for swimming, surfing, and sunsets.' },
  {
  ...
  { name: 'Food & Dining', slug: 'food-dining', icon: '🍽️', description: 'Restaurants, street food, cafés, and bars.' },
  { name: 'Nightlife', slug: 'nightlife', icon: '🌙', description: 'Bars, live music, and after-dark spots.' },
  {
  ...
  { name: 'Hotels & Lodges', slug: 'hotels-lodges', icon: '🏨', description: 'Places to stay, from guesthouses to resorts.' },
  { name: 'City & Shopping', slug: 'city-shopping', icon: '🛍️', description: 'Markets, city life, and shopping districts.' },
  {
    ...
    activities: [
      {
        ...
        description: 'Board and basic instruction with a local surf instructor.',
        duration: '1.5 hours',
        price: 25,
    ...
    activities: [
      {
        ...
        description: 'Guided canoe trip through the mangrove channels with a local fisherman guide.',
        duration: '2 hours',
        price: 20,
        difficulty: ActivityDifficulty.EASY,
        ageRange: 'All ages',
    ...
    activities: [
      {
        ...
        description: 'Guided walk covering Providence Island, Waterside Market, and Ducor Hill.',
        duration: '4 hours',
        price: 30,
        difficulty: ActivityDifficulty.EASY,
        ageRange: 'All ages',
